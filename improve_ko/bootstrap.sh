...
# Start single Ollama server on GPU0 -> port 11434
...
# Pull & warm models on this single instance (GPU0)
# qwen3 instruct (LLM) + nomic-embed-text (embeddings)
for m in \
...
echo "Ready: single Ollama on GPU0 (port 11434, PID $(cat /workspace/ollama-gpu0.pid))"
